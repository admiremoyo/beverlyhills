...
const schools = [
  ...
  },
  {
    ...
    description:
      "Our Secondary School prepares learners for ZIMSEC O-Level examinations with a broad curriculum that builds analytical thinking, scientific reasoning, and practical life skills.",
  ...
  },
  {
    ...
    tag: "High School",
    title: "High School",
    subtitle: "Form 5 – Form 6 (A-Level)",
    description:
      "Our Advanced Level programme equips students for university entrance with focused academic streams in Sciences, Commerce, and Arts — guided by experienced teachers.",
    subjects: ["Advanced Mathematics", "Physics", "Chemistry", "Biology", "Business Studies", "Accounting", "History"],
